...
void btn_click(){
		...
		if(state==0){
			__HAL_TIM_SET_COMPARE(&htim2,TIM_CHANNEL_1,10);//1ms
		}else{
			__HAL_TIM_SET_COMPARE(&htim2,TIM_CHANNEL_1,15); // 1.5ms
		}	
}
/* USER CODE END 0 */
...
HAL_TIM_PWM_Start(&htim2,TIM_CHANNEL_1);
  ...
  /* USER CODE BEGIN WHILE */
	...
	/*servo sg90 hoat dong tai tan so 50HZ
	1ms: 0do
	1.5ms 90do
	2ms180do*/
	__HAL_TIM_SET_COMPARE(&htim2,TIM_CHANNEL_1,10); // 1ms
